...
class _RequestsScreenState extends State<RequestsScreen> {
  ...
  List<String> _budgetFilters = const [
    'Todos',
    'Menos de 500',
    '500 - 1500',
    'Más de 1500',
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                              MultiLanguages.of(
                                    context,
                                  )?.translate('requests_explore_title') ??
                                  'Explora solicitudes publicadas',
                              style: Style.getHeaderTwo(
                                color: Style.getTextColor(),
                                fontWeight: FontWeight.w800,
                                fontSize: 15,
                            ...
                            Text(
                              MultiLanguages.of(
                                    context,
                                  )?.translate('requests_explore_subtitle') ??
                                  'Busca oportunidades y contacta al solicitante desde el chat interno.',
