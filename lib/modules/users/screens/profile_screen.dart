                            ...
                            _sectionCard(
                              children: [
                                ...
                                Tiles.settingTile(
                                  ...
                                  title: MultiLanguages.of(
                                    context,
                                  )!.translate('reputation_level'),
                                  subtitle: _reputationLevel,
                                  icon: Icon(
                                ...
                                _divider(),
                                Padding(
                                  padding: Style.getPaddingSymmetric(
                                    horizontal: 14,
                                    vertical: 12,
                                  ),
                                  child: Row(
                                    children: [
                                      Expanded(
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            SizedBox(height: 4.h),
                                            Text(
                                              '${_reputationRating.toStringAsFixed(1)} / 5.0',
                                              style: Style.getTextStyle(
                                                color:
                                      ...
                                      _ratingStars(_reputationRating),
                                    ],
                                  ),
                                ),
                              ],
                            ...
                            _sectionCard(
                              children: [
                                ...
                                Tiles.settingTile(
                                  ...
                                  subtitle: MultiLanguages.of(
                                    context,
                                  )!.translate('help_center_description'),
                                  icon: Icon(
